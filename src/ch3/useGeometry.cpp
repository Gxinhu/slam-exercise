...
int main(int argc, char **argv)
{
    ...
    auto original_quaternion_rotate = rotated_quaternion * Eigen::Quaterniond(0, 1, 0, 0) * rotated_quaternion.inverse();
    std::cout << "(1,0,0) after rotation (by quaternion)= " << original_quaternion_rotate.coeffs().transpose() << std::endl;
